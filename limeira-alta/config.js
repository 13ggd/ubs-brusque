...
const CONFIG = {
  ...
  unidade: {
    ...
    nome:     'UBS Limeira Alta',
    subtitulo:'Unidade Básica de Saúde',
    endereco: 'R. Alberto Muller, 6640-7014',
    bairro:   'Bairro Limeira — Brusque/SC',
    telefone: '(47) 20170-538',
    telefoneLink: '+554720170538',
    ...
    mapa: 'UBS Limeira Alta, R. Alberto Muller, 6640-7014, Brusque - SC',
    instagram: '',

    /* Endereço do site depois de publicado (ex: 'https://ubs-brusque.vercel.app/limeira-alta').
       Preenchido no passo final da publicação; usado só pelo cartaz.html
       para gerar o QR code impresso. */
    site: 'https://ubs-brusque.vercel.app/limeira-alta',
  ...
  */
  planilhaId:  '1p9cpqf840rVkZ0YF9qVi-XI2a2sYmNv4EoZ4Nu97Olg',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-538 antes de vir.',
