...
const CONFIG = {
  ...
  unidade: {
    ...
    endereco: 'R. Oito de Dezembro, 360',
    bairro:   'Bairro Santa Terezinha — Brusque/SC',
    telefone: '(47) 20170-551',
    telefoneLink: '+554720170551',
    ...
    mapa: 'UBS Planalto, R. Oito de Dezembro, 360, Brusque - SC',
    instagram: '',

    /* Endereço do site depois de publicado (ex: 'https://ubs-brusque.vercel.app/planalto').
       Preenchido no passo final da publicação; usado só pelo cartaz.html
       para gerar o QR code impresso. */
    site: 'https://ubs-brusque.vercel.app/planalto',
  ...
  */
  planilhaId:  '1VWdk9ib_2xgI6K74RF_trUvaFZlpxElaC79AYs2Vb6Q',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-551 antes de vir.',
