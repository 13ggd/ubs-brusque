...
const CONFIG = {
  ...
  unidade: {
    ...
    endereco: 'R. Pedro Gracher, s/n',
    bairro:   'Bairro São Luiz — Brusque/SC',
    telefone: '(47) 20170-579',
    telefoneLink: '+554720170579',
  ...
  */
  planilhaId:  '1s7WGkVLDU87FJjsOspS_aigwb5FOML2jGhxUPt3EVfY',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-579 antes de vir.',
