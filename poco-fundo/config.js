...
const CONFIG = {
  ...
  unidade: {
    ...
    endereco: 'R. Poço Fundo, s/n',
    bairro:   'Bairro Poço Fundo — Brusque/SC',
    telefone: '(47) 20170-554',
    telefoneLink: '+554720170554',
  ...
  */
  planilhaId:  '1bVOmXsx1xujTn1KDxkRAHdqs7lwA29B-Zuxp5UWTpYI',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-554 antes de vir.',
