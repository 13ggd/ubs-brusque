...
const CONFIG = {
  ...
  unidade: {
    ...
    nome:     'UBS Ponta Russa',
    subtitulo:'Unidade Básica de Saúde',
    endereco: 'R. Ponta Russa, 1328',
    bairro:   'Bairro Ponta Russa — Brusque/SC',
    telefone: '(47) 20170-557',
    telefoneLink: '+554720170557',
  ...
  */
  planilhaId:  '1l8JcZLzcSaXvdwhFxg3Orvw4dCkCqp5LrEh-ofG4iHI',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-557 antes de vir.',
