...
const CONFIG = {
  ...
  unidade: {
    ...
    endereco: 'R. Nicolau Hassman, 71',
    bairro:   'Bairro Guarani — Brusque/SC',
    telefone: '(47) 20170-530',
    telefoneLink: '+554720170530',
  ...
  */
  planilhaId:  '1AriG6tiVcNaVcgvpa48mxJXMshn7jj53MyDzD8dXiLI',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-530 antes de vir.',
