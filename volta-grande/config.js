...
const CONFIG = {
  ...
  unidade: {
    ...
    nome:     'UBS Volta Grande',
    subtitulo:'Unidade Básica de Saúde',
    endereco: 'Rua Alberto Michei, sn',
    bairro:   'Bairro Volta Grande — Brusque/SC',
    telefone: '(47) 20170-588',
    telefoneLink: '+554720170588',
  ...
  */
  planilhaId:  '1ooAgCNoONvoRrcgv6BdYNXffKiplO8s4z_y35m_GpnQ',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-588 antes de vir.',
