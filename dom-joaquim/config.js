...
const CONFIG = {
  ...
  unidade: {
    ...
    nome:     'UBS Dom Joaquim',
    subtitulo:'Unidade Básica de Saúde',
    endereco: 'R. Armando Pedro Maestri, 300',
    bairro:   'Bairro Dom Joaquim — Brusque/SC',
    telefone: '(47) 20170-524',
    telefoneLink: '+554720170524',
  ...
  */
  planilhaId:  '1yxPU7qIQJ7hpucyZ_BQbqUtVNxwJwsBBriL_kU6XthQ',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-524 antes de vir.',
