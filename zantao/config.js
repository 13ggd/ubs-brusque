...
const CONFIG = {
  ...
  unidade: {
    ...
    endereco: 'Rua Arnoldo Ristow, S/N',
    bairro:   'Bairro Zantão — Brusque/SC',
    telefone: '(47) 20170-591',
    telefoneLink: '+554720170591',
  ...
  */
  planilhaId:  '1RtHknfXkkbXK6FG-gGPGX_4nDwZsamaGe0RGrbJNg3o',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-591 antes de vir.',
