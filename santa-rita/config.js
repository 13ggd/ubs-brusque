...
const CONFIG = {
  ...
  unidade: {
    ...
    endereco: 'R. Olibio Barbi, 177',
    bairro:   'Bairro Santa Rita — Brusque/SC',
    telefone: '(47) 20170-569',
    telefoneLink: '+554720170569',
  ...
  */
  planilhaId:  '1gBB8Iiy_Ov8BgbGEmkhQn2oIzKxYa8Si51t2gO7OYgY',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-569 antes de vir.',
