...
const CONFIG = {
  ...
  unidade: {
    ...
    telefone: '(47) 20170-533',
    telefoneLink: '+554720170533',
    ...
    mapa: 'UBS Limeira, R. Alberto Muller, 6640-7014, Brusque - SC',
    instagram: '',

    /* Endereço do site depois de publicado (ex: 'https://ubs-brusque.vercel.app/limeira').
       Preenchido no passo final da publicação; usado só pelo cartaz.html
       para gerar o QR code impresso. */
    site: 'https://ubs-brusque.vercel.app/limeira',
  ...
  */
  planilhaId:  '1nKLTu5u6y4GiuO7UXE2GRKOUjHQrmizEInSkPCZ1dVI',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-533 antes de vir.',
