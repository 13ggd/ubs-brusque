...
const CONFIG = {
  ...
  unidade: {
    ...
    nome:     'UBS Rua Nova Trento',
    subtitulo:'Unidade Básica de Saúde',
    endereco: 'Rua Luiz Vanolli, 295',
    bairro:   'Bairro Azambuja — Brusque/SC',
    telefone: '(47) 20170-563',
    telefoneLink: '+554720170563',
    ...
    mapa: 'UBS Rua Nova Trento, Rua Luiz Vanolli, 295, Brusque - SC',
    instagram: '',

    /* Endereço do site depois de publicado (ex: 'https://ubs-brusque.vercel.app/rua-nova-trento').
       Preenchido no passo final da publicação; usado só pelo cartaz.html
       para gerar o QR code impresso. */
    site: 'https://ubs-brusque.vercel.app/rua-nova-trento',
  ...
  */
  planilhaId:  '1W83iRYMJKSU9c_zLor36HqFaRG_tiDoQ-4vQIgGrX2U',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-563 antes de vir.',
