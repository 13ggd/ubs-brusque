...
const CONFIG = {
  ...
  unidade: {
    ...
    endereco: 'R. Juvenal Vechi, 06',
    bairro:   'Bairro Santa Terezinha — Brusque/SC',
    telefone: '(47) 20170-527',
    telefoneLink: '+554720170527',
  ...
  */
  planilhaId:  '1WJSLhyTfXMoeJ_1cRL1Nm6i0xSHlE1Zc4qXNZOfQq4w',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-527 antes de vir.',
      inicio:'2026-09-11', fim:'2027-12-31', novo:'' }
  ],
