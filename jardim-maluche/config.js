...
const CONFIG = {
  ...
  unidade: {
    ...
    nome:     'UBS Jardim Maluche',
    subtitulo:'Unidade Básica de Saúde',
    endereco: 'Av. Dom Joaquim, 560',
    bairro:   'Bairro Jardim Maluche — Brusque/SC',
    telefone: '(47) 20170-541',
    telefoneLink: '+554720170541',
    ...
    mapa: 'UBS Jardim Maluche, Av. Dom Joaquim, 560, Brusque - SC',
    instagram: '',

    /* Endereço do site depois de publicado (ex: 'https://ubs-brusque.vercel.app/jardim-maluche').
       Preenchido no passo final da publicação; usado só pelo cartaz.html
       para gerar o QR code impresso. */
    site: 'https://ubs-brusque.vercel.app/jardim-maluche',
  ...
  */
  planilhaId:  '1Zq53hB5s3hL9hZK5aPdpAPKPJg-Vqiv-6EP-TA0jE3s',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-541 antes de vir.',
