...
const CONFIG = {
  ...
  unidade: {
    ...
    endereco: 'R. Bertoldo Todt, 01',
    bairro:   'Bairro Bateas — Brusque/SC',
    telefone: '(47) 20170-515',
    telefoneLink: '+554720170515',
  ...
  */
  planilhaId:  '1Wg67wYnKInaIGpZPHJfekHK4wvDeagksj1gHY7GsGrg',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-515 antes de vir.',
