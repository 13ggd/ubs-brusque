...
const CONFIG = {
  ...
  unidade: {
    ...
    nome:     'UBS Santa Luzia',
    subtitulo:'Unidade Básica de Saúde',
    endereco: 'R. Augusto Klapoth, 1306',
    bairro:   'Bairro Santa Luzia — Brusque/SC',
    telefone: '(47) 20170-566',
    telefoneLink: '+554720170566',
    ...
    mapa: 'UBS Santa Luzia, R. Augusto Klapoth, 1306, Brusque - SC',
    instagram: '',

    /* Endereço do site depois de publicado (ex: 'https://ubs-brusque.vercel.app/santa-luzia').
       Preenchido no passo final da publicação; usado só pelo cartaz.html
       para gerar o QR code impresso. */
    site: 'https://ubs-brusque.vercel.app/santa-luzia',
  ...
  */
  planilhaId:  '1GiKgIsk9JBEod45nGVP1MwL9GNaS-GCIWs8csgwW7pQ',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-566 antes de vir.',
