...
const CONFIG = {
  ...
  unidade: {
    ...
    endereco: 'R. Adelina Debatin, 124',
    bairro:   'Bairro Águas Claras — Brusque/SC',
    telefone: '(47) 20170-507',
    telefoneLink: '+554720170507',
  ...
  */
  planilhaId:  '1mou4IT6NjGcp4PFIpECp7aRsDQZJULTlWqITxn3c3R0',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-507 antes de vir.',
