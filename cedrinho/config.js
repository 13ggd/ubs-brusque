...
const CONFIG = {
  ...
  unidade: {
    ...
    endereco: 'Rua Ilda de Melo Kinis, s/n',
    bairro:   'Bairro Cedrinho — Brusque/SC',
    telefone: '(47) 20170-518',
    telefoneLink: '+554720170518',
    ...
    mapa: 'UBS Cedrinho, Rua Ilda de Melo Kinis, s/n, Brusque - SC',
    instagram: '',

    /* Endereço do site depois de publicado (ex: 'https://ubs-brusque.vercel.app/cedrinho').
       Preenchido no passo final da publicação; usado só pelo cartaz.html
       para gerar o QR code impresso. */
    site: 'https://ubs-brusque.vercel.app/cedrinho',
  ...
  */
  planilhaId:  '1ekhrgJneHLzU0NErDncaCxRrcBv5H_7mmG69XTsoFLc',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-518 antes de vir.',
