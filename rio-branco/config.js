...
const CONFIG = {
  ...
  unidade: {
    ...
    endereco: 'R. Marcio Haas',
    bairro:   'Bairro Rio Branco — Brusque/SC',
    telefone: '(47) 20170-560',
    telefoneLink: '+554720170560',
  ...
  */
  planilhaId:  '18zHGVanNssI37McJ0BMERgX3c9rz2Ivp7O9Yydx6jfM',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-560 antes de vir.',
