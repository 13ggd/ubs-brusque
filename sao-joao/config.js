...
const CONFIG = {
  ...
  unidade: {
    ...
    endereco: 'R. Franciso Thives de Souza, sn',
    bairro:   'Bairro Cedro Alto — Brusque/SC',
    telefone: '(47) 20170-576',
    telefoneLink: '+554720170576',
    ...
    mapa: 'UBS São João, R. Franciso Thives de Souza, sn, Brusque - SC',
    instagram: '',

    /* Endereço do site depois de publicado (ex: 'https://ubs-brusque.vercel.app/sao-joao').
       Preenchido no passo final da publicação; usado só pelo cartaz.html
       para gerar o QR code impresso. */
    site: 'https://ubs-brusque.vercel.app/sao-joao',
  ...
  */
  planilhaId:  '1E7Wgzd5WPbBQ0baBH2NLIG8ITQnGqcrwgoIKRzCpJJo',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-576 antes de vir.',
