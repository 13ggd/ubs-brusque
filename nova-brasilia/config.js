...
const CONFIG = {
  ...
  unidade: {
    ...
    nome:     'UBS Nova Brasília',
    subtitulo:'Unidade Básica de Saúde',
    endereco: 'R. Osvaldo Niebuhr, 425',
    bairro:   'Bairro Nova Brasília — Brusque/SC',
    telefone: '(47) 20170-545',
    telefoneLink: '+554720170545',
    ...
    mapa: 'UBS Nova Brasília, R. Osvaldo Niebuhr, 425, Brusque - SC',
    instagram: '',

    /* Endereço do site depois de publicado (ex: 'https://ubs-brusque.vercel.app/nova-brasilia').
       Preenchido no passo final da publicação; usado só pelo cartaz.html
       para gerar o QR code impresso. */
    site: 'https://ubs-brusque.vercel.app/nova-brasilia',
  ...
  */
  planilhaId:  '1LoFTxsQ9HRldh7LAmu5NXXpSgep8Hs5q3uuiNf86BX4',
  abaSetores:  'setores',
  ...
  avisosReserva: [
    { tipo:'recado', setor:'', ativo:true,
      ...
      texto:'Endereço e telefone confirmados junto à Secretaria de Saúde de Brusque. O horário de ' +
            'atendimento e a equipe ainda não foram confirmados — ligue para (47) 20170-545 antes de vir.',
